...
import (
	...
	"github.com/meeypioneer/mey-library/db"
...
// GetSystemAccountState returns the ContractState of the MEYCOIN system account.
func (states *StateDB) GetSystemAccountState() (*ContractState, error) {
	return states.OpenContractStateAccount(types.ToAccountID([]byte(types.MeyCoinSystem)))
}

// GetNameAccountState returns the ContractState of the MEYCOIN name account.
func (states *StateDB) GetNameAccountState() (*ContractState, error) {
	return states.OpenContractStateAccount(types.ToAccountID([]byte(types.MeyCoinName)))
}

// GetEnterpriseAccountState returns the ContractState of the MEYCOIN enterprise account.
func (states *StateDB) GetEnterpriseAccountState() (*ContractState, error) {
	return states.OpenContractStateAccount(types.ToAccountID([]byte(types.MeyCoinEnterprise)))
}
