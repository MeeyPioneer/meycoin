...
import (
	...
	etcdtypes "github.com/meeypioneer/etcd/pkg/types"
	raftlib "github.com/meeypioneer/etcd/raft"
...
func (rs *raftServer) startTransport() {
	...
	rs.transport = rs.createMeyCoinP2PTransporter()
...
func (rs *raftServer) createMeyCoinP2PTransporter() Transporter {
