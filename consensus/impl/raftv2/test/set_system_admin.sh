...
# set admin
CLI="meycoincli -p $_leaderport_"
ADMIN=
getAdminUnlocked $_leaderport_ ./genesis_wallet.txt ADMIN

echo "$CLI contract call --governance $ADMIN meycoin.enterprise appendAdmin '[\"$ADMIN\"]' --keystore . --password 1234"
$CLI contract call --governance $ADMIN meycoin.enterprise appendAdmin '["'$ADMIN'"]' --keystore . --password 1234
