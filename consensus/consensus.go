...
type ConsensusAccessor interface {
	...
	// RaftAccessor returns MeyCoinRaftAccessor. It is only valid if chain is raft consensus
	RaftAccessor() MeyCoinRaftAccessor
}
...
// MeyCoinRaftAccessor is interface to access raft messaging. It is wrapping raft message with meycoin internal types
type MeyCoinRaftAccessor interface {
