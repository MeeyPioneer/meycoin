...
import (
	...
	luacUtil "github.com/meeypioneer/meycoin/cmd/meycoinluac/util"
...
func newExecutor(
	...
	if ce.L == nil {
		ce.err = ErrVmStart
		ctrLgr.Error().Err(ce.err).Str("contract", types.EncodeAddress(contractId)).Msg("new MeyCoinLua executor")
		return ce
	}
