...
func init() {
	rootCmd = &cobra.Command{
		Use:   "meycoinluac --payload srcfile\n  meycoinluac --abi abifile srcfile bcfile",
	...
	rootCmd.PersistentFlags().BoolVar(&version, "version", false, "print the version number of meycoinluac")
}
