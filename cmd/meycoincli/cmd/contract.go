...
import (
	...
	luacEncoding "github.com/meeypioneer/meycoin/cmd/meycoinluac/encoding"
	luac "github.com/meeypioneer/meycoin/cmd/meycoinluac/util"
...
func init() {
  ...
  meycoincli contract deploy [flags] <creatorAddress> <bcfile> <abifile> [args]
