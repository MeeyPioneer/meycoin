...
func init() {
	initGenesis.Flags().BoolVar(&testNet, "testnet", false, "create genesis block for MeyCoin TestNet")
...
var initGenesis = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		if genesis == nil {
			if testNet == false {
				fmt.Println("create genesis block for MeyCoin Mainnet")
			} else {
				fmt.Println("create genesis block for MeyCoin Testnet")
			}
		}
