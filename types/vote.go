...
const (
	MeyCoinSystem     = "meycoin.system"
	MeyCoinName       = "meycoin.name"
	MeyCoinEnterprise = "meycoin.enterprise"
	MeyCoinVault      = "meycoin.vault" // For community reward program (i.e. voting reward)
...
func init() {
	...
	specialAccounts = append(specialAccounts, []byte(MeyCoinSystem))
	specialAccounts = append(specialAccounts, []byte(MeyCoinName))
	specialAccounts = append(specialAccounts, []byte(MeyCoinEnterprise))
	specialAccounts = append(specialAccounts, []byte(MeyCoinVault))
}
