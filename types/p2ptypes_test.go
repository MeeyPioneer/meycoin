...
func TestParseMultiaddrWithResolve(t *testing.T) {
	tests := []struct {
		...
		//FIXME
		{"TDomainName", "/dns/meycoin.io/tcp/11004/p2p/16Uiu2HAmHuBgtnisgPLbujFvxPNZw3Qvpk3VLUwTzh5C67LAZSFh", multiaddr.P_DNS4, []net.IP{}, "11004", false},
		{"TInvalidDomain", "/dns4/!nowhere.a.meycoin.io/tcp/11004/p2p/16Uiu2HAmHuBgtnisgPLbujFvxPNZw3Qvpk3VLUwTzh5C67LAZSFh", multiaddr.P_DNS4, []net.IP{}, "11004", false},
...
func TestGetIPFromMultiaddr(t *testing.T) {
	tests := []struct {
		...
		{"TDomainName", "/dns/meycoin.io/tcp/11004/p2p/16Uiu2HAmHuBgtnisgPLbujFvxPNZw3Qvpk3VLUwTzh5C67LAZSFh", multiaddr.P_DNS4, nil},
		{"TInvalidDomain", "/dns4/!nowhere.a.meycoin.io/tcp/11004/p2p/16Uiu2HAmHuBgtnisgPLbujFvxPNZw3Qvpk3VLUwTzh5C67LAZSFh", multiaddr.P_DNS4, nil},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
