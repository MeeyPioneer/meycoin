...
func TestFromMultiAddrStringWithPID(t *testing.T) {
	tests := []struct {
		...
		{"TDNS", "/dns/mainnet-wezen.meycoin.io/tcp/8916", "16Uiu2HAkuxyDkMTQTGFpmnex2SdfTVzYfPztTyK339rqUdsv3ZUa", "mainnet-wezen.meycoin.io", 8916, false},
		{"TDNS4", "/dns4/mainnet-wezen.meycoin.io/tcp/8916", "16Uiu2HAkuxyDkMTQTGFpmnex2SdfTVzYfPztTyK339rqUdsv3ZUa", "mainnet-wezen.meycoin.io", 8916, false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestPeerMeta_ToMultiAddr(t *testing.T) {
	...
	tests := []struct {
		...
		//{"t5", fields{"www.meycoin.io", 444, "id0002"}, false, multiaddr.P_IP4},
...
func TestFromMultiAddrString(t *testing.T) {
	tests := []struct {
		...
		{"TDomainName", "/dns/mainnet-wezen.meycoin.io/tcp/8916/p2p/16Uiu2HAkuxyDkMTQTGFpmnex2SdfTVzYfPztTyK339rqUdsv3ZUa", "mainnet-wezen.meycoin.io", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
...
func TestFromMultiAddrToPeerInfo(t *testing.T) {
	tests := []struct {
		...
		{"TDomainName", "/dns4/mainnet-wezen.meycoin.io/tcp/8916/p2p/16Uiu2HAkuxyDkMTQTGFpmnex2SdfTVzYfPztTyK339rqUdsv3ZUa", "/dns4/mainnet-wezen.meycoin.io/tcp/8916", false},
		{"TDomainName6", "/dns6/mainnet-wezen.meycoin.io/tcp/8916/p2p/16Uiu2HAkuxyDkMTQTGFpmnex2SdfTVzYfPztTyK339rqUdsv3ZUa", "/dns6/mainnet-wezen.meycoin.io/tcp/8916", false},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
