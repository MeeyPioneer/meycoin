...
func TestV200StatusHS_doForOutbound(t *testing.T) {
	...
	dummyMeta := p2pcommon.NewMetaWith1Addr(samplePeerID, "dummy.meycoin.io", 7846, "v2.0.0")
...
func TestV200Handshaker_checkAgent(t *testing.T) {
	...
	selfMeta := p2pcommon.NewMetaWith1Addr(samplePeerID, "dummy.meycoin.io", 7846, "v2.0.0")
