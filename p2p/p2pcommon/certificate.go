...
//go:generate sh -c "mockgen github.com/meeypioneer/meycoin/p2p/p2pcommon CertificateManager | sed -e 's/^package mock_p2pcommon/package p2pmock/g' > ../p2pmock/mock_certificate.go"
