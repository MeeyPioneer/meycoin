...
const (
	...
	P2PVersion200     P2PVersion = 0x00020000 // following meycoin version. support peer role and multiple addresses
)

// AcceptedInboundVersions is list of versions this meycoinsvr supports. The first is the best recommended version.
...
const (
	P2PSubAddr       core.ProtocolID = "/meycoinp2p"
	RaftSnapSubAddr  core.ProtocolID = "/meycoinp2p/raftsnap"
)
...
const (
	DefaultPkKeyPrefix = "mey-peer"
	DefaultPkKeyExt    = ".key"
	DefaultPubKeyExt   = ".pub"
	DefaultPeerIDExt   = ".id"
)

// constants for inter-communication of meycoinsvr
const (
	// other actor
