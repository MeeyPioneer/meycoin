...
func Test_bpCertificateManager_CreateCertificate(t *testing.T) {
	...
	sampleAddrs := []types.Multiaddr{test.Multiaddr("/ip4/192.168.1.2/tcp/7846"), test.Multiaddr("/ip4/172.21.3.4/tcp/7846"), test.Multiaddr("/dns4/test.meycoin.io/tcp/7846")}
