...
func (rpc *MeyCoinRPCService) setClientAuth(conf *types.EnterpriseConfig) {
...
func (rpc *MeyCoinRPCService) setClientAuthOn(v bool) {
	rpc.clientAuthLock.Lock()
	defer rpc.clientAuthLock.Unlock()
...
func (rpc *MeyCoinRPCService) setClientAuthMap(v []string) {
	rpc.clientAuthLock.Lock()
...
func (rpc *MeyCoinRPCService) checkAuth(ctx context.Context, auth Authentication) error {
